...
export class ClientApi extends BaseClient {
     ...
     */
    addressCreate(body: RegisterAddress , cancelToken?: CancelToken | undefined): Promise<any> {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processAddressCreate(_response));
        });
    }

    protected processAddressCreate(response: AxiosResponse): Promise<any> {
     ...
     * @return Address Informations
     */
    addressUpdate:id(body: RegisterAddress , cancelToken?: CancelToken | undefined): Promise<any> {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processAddressUpdate:id(_response));
        });
    }

    protected processAddressUpdate:id(response: AxiosResponse): Promise<any> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 201) {
            ...
            return Promise.resolve<any>(result201);
     ...
     */
    addressAll(  cancelToken?: CancelToken | undefined): Promise<any> {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processAddressAll(_response));
        });
    }

    protected processAddressAll(response: AxiosResponse): Promise<any> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     * @return Address Informations
     */
    addressOne:id(  cancelToken?: CancelToken | undefined): Promise<any> {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processAddressOne:id(_response));
        });
    }

    protected processAddressOne:id(response: AxiosResponse): Promise<any> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     */
    addressDelete:id(  cancelToken?: CancelToken | undefined): Promise<any> {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processAddressDelete:id(_response));
        });
    }

    protected processAddressDelete:id(response: AxiosResponse): Promise<any> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     */
    authRegister(body: RegisterBody , cancelToken?: CancelToken | undefined): Promise<UserResponse> {
    ...
    protected processAuthRegister(response: AxiosResponse): Promise<UserResponse> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     * @return Account Informations
     */
    authLogin(body: LoginBody , cancelToken?: CancelToken | undefined): Promise<TokenResponse> {
    ...
    protected processAuthLogin(response: AxiosResponse): Promise<TokenResponse> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 201) {
            ...
            return Promise.resolve<TokenResponse>(result201);
     ...
     * @return Authentification Informations
     */
    authLogout(  cancelToken?: CancelToken | undefined): Promise<AuthInfos> {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processAuthLogout(_response));
        });
    }

    protected processAuthLogout(response: AxiosResponse): Promise<AuthInfos> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 200) {
            ...
            return Promise.resolve<AuthInfos>(result200);
     ...
     * @return Authentification Informations
     */
    authStatus(  cancelToken?: CancelToken | undefined): Promise<AuthInfos> {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processAuthStatus(_response));
        });
    }

    protected processAuthStatus(response: AxiosResponse): Promise<AuthInfos> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     * @return success
     */
    departmentAll(  cancelToken?: CancelToken | undefined): Promise<any> {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processDepartmentAll(_response));
        });
    }

    protected processDepartmentAll(response: AxiosResponse): Promise<any> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     * @return success
     */
    departmentOne:id(  cancelToken?: CancelToken | undefined): Promise<any> {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processDepartmentOne:id(_response));
        });
    }

    protected processDepartmentOne:id(response: AxiosResponse): Promise<any> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     * @return success
     */
    mail(body: Email , cancelToken?: CancelToken | undefined): Promise<void> {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processMail(_response));
        });
    }

    protected processMail(response: AxiosResponse): Promise<void> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     * @return success
     */
    mails(body: Emails , cancelToken?: CancelToken | undefined): Promise<void> {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processMails(_response));
        });
    }

    protected processMails(response: AxiosResponse): Promise<void> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     */
    roleCreate(body: RegisterRole , cancelToken?: CancelToken | undefined): Promise<any> {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processRoleCreate(_response));
        });
    }

    protected processRoleCreate(response: AxiosResponse): Promise<any> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     * @return Role Informations
     */
    roleUpdate:id(body: RegisterRole , cancelToken?: CancelToken | undefined): Promise<any> {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processRoleUpdate:id(_response));
        });
    }

    protected processRoleUpdate:id(response: AxiosResponse): Promise<any> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     * @return Role Informations
     */
    roleAll(  cancelToken?: CancelToken | undefined): Promise<any> {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processRoleAll(_response));
        });
    }

    protected processRoleAll(response: AxiosResponse): Promise<any> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     * @return Role Informations
     */
    roleOne:id(  cancelToken?: CancelToken | undefined): Promise<any> {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processRoleOne:id(_response));
        });
    }

    protected processRoleOne:id(response: AxiosResponse): Promise<any> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     * @return Role Informations
     */
    roleDelete:id(  cancelToken?: CancelToken | undefined): Promise<any> {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processRoleDelete:id(_response));
        });
    }

    protected processRoleDelete:id(response: AxiosResponse): Promise<any> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     */
    oauth2Google(  cancelToken?: CancelToken | undefined): Promise<FileResponse> {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processOauth2Google(_response));
        });
    }

    protected processOauth2Google(response: AxiosResponse): Promise<FileResponse> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     */
    oauth2GoogleRedirect(  cancelToken?: CancelToken | undefined): Promise<void> {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processOauth2GoogleRedirect(_response));
        });
    }

    protected processOauth2GoogleRedirect(response: AxiosResponse): Promise<void> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
